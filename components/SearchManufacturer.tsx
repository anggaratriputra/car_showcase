...
const SearchManufacturer = ({ manufacturer, setManufacturer }: SearchManufacturerProps) => {
  ...
  const filteredManufacturers = query === "" ? manufacturers : manufacturers.filter((item) => item.toLowerCase().replace(/\s+/g, "").replace(/\s+/g, "").includes(query.toLowerCase().replace(/\s+/g, "")));
  return (
